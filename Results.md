...
The function also reports R2, which is not a good score for our case as we aggregate the individual inverter results to daily predictions.
...
|Support vector regression - Plant 1|[link](/Analysis/Support%20vector%20regression.ipynb)| Uses only hour and DC POWER per inverter one day ago |RMSE:1089902.0; MAE:698708.0; R2:-1.00637|RMSE:1768.0; MAE:894.0; R2:0.7676|Completed
...
|Support vector regression - Plant 2|[link](/Analysis/Support%20vector%20regression.ipynb)|Uses only hour and DC POWER per inverter one day ago |RMSE:82134.0; MAE:77719.0; R2:-1.61012|RMSE:230.0; MAE:111.0; R2:0.3689|Completed
